...
//
        FormatDownload f1 = new FormatDownload(1,1,"3gp","3gp\t\t\t\t240","http://eduardperez.000webhostapp.com/video/1_3.3gp");
    ...
    public void insertFormats(ArrayList<FormatDownload>formats){
