...
public class Util {
    ...
    public static final String DB_NAME = "DATABASEASTRIXAPP2";
    ...
    public static final String INSERT_INITIAL_STATUS = "INSERT INTO STATUS (VERSION, IS_DOWNLOADED) VALUES ('"+CURRENT_VERSION+"', 0)";
